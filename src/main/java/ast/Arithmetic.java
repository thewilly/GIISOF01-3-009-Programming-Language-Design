...
public class Arithmetic implements Expression {
     ...
     * @param right
     */
    public Arithmetic(int line, int column, Arithmetic left, String arithmeticOperator, Arithmetic right) {
	this.line = line;
	this.column = column;
	this.left = left;
    ...
    /**
     * Allocates an arithmetic object and initializes it so that it represents and
     * arithmetic expression composed by Arithmetic operator Variable.
     * 
     * @param line
     *            of the expression.
     * @param column
    ...
    /**
     * Allocates an arithmetic object and initializes it so that it represents and
     * arithmetic expression composed by UnaryMinus operator IntLiteral.
     * 
     * @param line
     *            of the expression.
     * @param column
    ...
    /**
     * Allocates an arithmetic object and initializes it so that it represents and
     * arithmetic expression composed by IntLiteral operator Variable.
     * 
     * @param line
     *            of the expression.
     * @param column
