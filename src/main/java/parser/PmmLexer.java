...
public class PmmLexer extends Lexer {
    ...
    public static final int SKIP_ = 1, INT_CONSTANT = 2, REAL_CONSTANT = 3, CHAR_CONSTANT = 4, ID = 5;
    public static String[] channelNames = { "DEFAULT_TOKEN_CHANNEL", "HIDDEN" };

    public static String[] modeNames = { "DEFAULT_MODE" };

    public static final String[] ruleNames = { "SKIP_", "WHITE_SPACE", "MULTI_LINE_COMMENT", "ONE_LINE_COMMENT",
	    "DIGIT", "EXPONENT", "FRACTION", "INT_CONSTANT", "REAL_CONSTANT", "CHAR_CONSTANT", "ID" };

    private static final String[] _LITERAL_NAMES = {};
    private static final String[] _SYMBOLIC_NAMES = { null, "SKIP_", "INT_CONSTANT", "REAL_CONSTANT", "CHAR_CONSTANT",
	    "ID" };
    ...
    public static final String _serializedATN = "\3\u608b\ua72a\u8133\ub9ed\u417c\u3be7\u7786\u5964\2\7\u008b\b\1\4\2\t"
	    ...
	    + "\u0089\3\2\2\2\u0089\30\3\2\2\2\u008a\u0088\3\2\2\2\21\2\34#,\67>CIPS" + "Vdi\u0082\u0088\3\b\2\2";
